...
function Banner() {
  return (
    ...
    style={{ fontFamily: "Montserrat" }} 
     className='text-8xl w-full h-screen break-before-column relative flex flex-col py-4 font-'>
      ...
      <div style={{ fontFamily: "Open Sans"}} className="text-lg text-center md:mx-auto">
